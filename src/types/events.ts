...
export class AssetsBurnedEvent {
     ...
     * Some assets were destroyed.
     */
    get asV4401(): {assetId: bigint, owner: Uint8Array, balance: bigint} {
        assert(this.isV4401)
...
export class AssetsIssuedEvent {
     ...
     * Some assets were issued.
     */
    get asV4401(): {assetId: bigint, owner: Uint8Array, totalSupply: bigint} {
        assert(this.isV4401)
        return this._chain.decodeEvent(this.event)
    }
...
export class AssetsTransferredEvent {
     ...
     * Some assets were transferred.
     */
    get asV4401(): {assetId: bigint, from: Uint8Array, to: Uint8Array, amount: bigint} {
        assert(this.isV4401)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class FarmingChargedEvent {
    ...
    get asV4401(): {who: Uint8Array, pid: bigint, rewards: [bigint, bigint][]} {
        assert(this.isV4401)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class FarmingClaimedEvent {
    ...
    get asV4401(): {who: Uint8Array, pid: bigint} {
        assert(this.isV4401)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class FarmingDepositedEvent {
    ...
    get asV4401(): {who: Uint8Array, pid: bigint, addValue: bigint, gaugeInfo: ([bigint, number] | undefined)} {
        assert(this.isV4401)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class FarmingGaugeWithdrawnEvent {
    ...
    get asV4401(): {who: Uint8Array, gid: bigint} {
        assert(this.isV4401)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class FarmingWithdrawnEvent {
    ...
    get asV4401(): {who: Uint8Array, pid: bigint, removeValue: (bigint | undefined)} {
        assert(this.isV4401)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ZenlinkProtocolAssetSwapEvent {
     ...
     * Transact in trading \[owner, recipient, swap_path, balances\]
     */
    get asV4401(): [Uint8Array, Uint8Array, v4401.AssetId[], bigint[]] {
        assert(this.isV4401)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ZenlinkProtocolLiquidityAddedEvent {
     ...
     * mint_balance_lp\]
     */
    get asV4401(): [Uint8Array, v4401.AssetId, v4401.AssetId, bigint, bigint, bigint] {
        assert(this.isV4401)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ZenlinkProtocolLiquidityRemovedEvent {
     ...
     * burn_balance_lp\]
     */
    get asV4401(): [Uint8Array, Uint8Array, v4401.AssetId, v4401.AssetId, bigint, bigint, bigint] {
        assert(this.isV4401)
        return this._chain.decodeEvent(this.event)
    }
}
